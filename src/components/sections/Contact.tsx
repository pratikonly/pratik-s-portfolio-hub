          ...
          <div>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground shrink-0 z-10" />
                <Input {...register('name')} placeholder="Your Name" className="pl-11 bg-card/50 border-border focus:border-primary h-12" />
              ...
              <div className="relative">
                <FileText className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground shrink-0 z-10" />
                <Input {...register('subject')} placeholder="Subject" className="pl-11 bg-card/50 border-border focus:border-primary h-12" />
