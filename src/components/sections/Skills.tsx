...
const BrandIcons: Record<string, JSX.Element> = {
 ...
 'node-js': (
  ...
  >
    ...
    <path
      fill="#FFFFFF"
      d="M256 64C150.13 64 64 150.13 64 256s86.13 192 192 192 192-86.13 192-192S361.87 64 256 64zm0 352c-88.37 0-160-71.63-160-160S167.63 96 256 96s160 71.63 160 160-71.63 160-160 160z"
    />
    <text
      x="256"
      y="300"
      ...
      fontSize="180"
      fontWeight="900"
      fill="#539E43"  // Node.js green to match theme, or use #000/#fff
      textAnchor="middle"
