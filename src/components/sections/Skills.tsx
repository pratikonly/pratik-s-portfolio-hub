...
const CustomIcons: Record<string, JSX.Element> = {
  ...
  typescript: (
    <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#3178C6">
      <path d="M1.5 0h21v24h-21z"/>
      <path fill="#fff" d="M13.2 18.6v-2.1c.6.3 1.4.6 2.4.6 1 0 1.5-.3 1.5-.9 0-.5-.3-.8-1.5-1.3-2.1-.8-2.7-1.8-2.7-3.2 0-1.9 1.5-3.1 3.8-3.1 1.2 0 2.1.2 2.7.5v2c-.6-.3-1.4-.6-2.4-.6-.9 0-1.4.4-1.4.9s.3.8 1.6 1.3c2 0.8 2.6 1.8 2.6 3.2 0 2-1.6 3.1-4 3.1-1.2 0-2.4-.3-2.6-.4zM5 9h6v2H9.5v7H7.6v-7H5z"/>
    </svg>
  ),

  tailwind: (
    <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#38BDF8">
      <path d="M12 6c-2.4 0-3.9 1.2-4.5 3.6 1-.9 2.1-1.2 3.3-.9.7.2 1.2.6 1.8 1.1.9.7 1.9 1.6 3.9 1.6 2.4 0 3.9-1.2 4.5-3.6-1 .9-2.1 1.2-3.3.9-.7-.2-1.2-.6-1.8-1.1-.9-.7-1.9-1.6-3.9-1.6zm-4.5 6c-2.4 0-3.9 1.2-4.5 3.6 1-.9 2.1-1.2 3.3-.9.7.2 1.2.6 1.8 1.1.9.7 1.9 1.6 3.9 1.6 2.4 0 3.9-1.2 4.5-3.6-1 .9-2.1 1.2-3.3.9-.7-.2-1.2-.6-1.8-1.1-.9-.7-1.9-1.6-3.9-1.6z"/>
    </svg>
  ),
  ...
  github: (
    <svg viewBox="0 0 24 24" className="w-7 h-7" fill="currentColor">
      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.565 21.411 24 16.914 24 11.614 24 4.987 18.627 0 12 0z"/>
    </svg>
  ),
};
